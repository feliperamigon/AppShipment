...
class ContainersControllerTest < ActionController::TestCase
  ...
  test "should create container" do
    assert_difference('Container.count') do
      post :create, container: { ,: @container.,, ,: @container.,, string: @container.string, string: @container.string, string: @container.string, user_id: @container.user_id }
    end
  ...
  test "should update container" do
    patch :update, id: @container, container: { ,: @container.,, ,: @container.,, string: @container.string, string: @container.string, string: @container.string, user_id: @container.user_id }
    assert_redirected_to container_path(assigns(:container))
  end
